...
public:
	...
	struct boss_lady_deathwhisperAI : public ScriptedAI
	{
		...
		void RandomSpawn()
		{
			...
			{
			case 0:
				me->SummonCreature(NPC_CULT_FANATIC,-619.006,2158.104,50.848,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				me->SummonCreature(NPC_CULT_ADHERENT,-598.697,2157.767,50.848,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				me->SummonCreature(NPC_CULT_FANATIC,-577.992,2156.989,50.848,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				break;
			case 1:
				me->SummonCreature(NPC_CULT_ADHERENT,-618.748,2266.648,50.849,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				me->SummonCreature(NPC_CULT_FANATIC,-598.573,2266.870,50.849,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				me->SummonCreature(NPC_CULT_ADHERENT,-578.360,2267.210,50.849,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
				break;
			}
		}
			...
			if (m_uiPhase == 1)
			{
				...
				if (m_uiSummonWaveTimer < uiDiff)
				{
					...
					if (getDifficulty() == RAID_DIFFICULTY_25MAN_NORMAL || getDifficulty() == RAID_DIFFICULTY_25MAN_HEROIC)
					{
						...
						me->SummonCreature(NPC_CULT_FANATIC,-598.573,2266.870,50.849,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
						me->SummonCreature(NPC_CULT_ADHERENT,-578.360,2267.210,50.849,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
						me->SummonCreature(RAND(NPC_CULT_FANATIC, NPC_CULT_ADHERENT), -555.643,2211.281,49.476,0,TEMPSUMMON_CORPSE_TIMED_DESPAWN,10000);
					}
					m_uiSummonWaveTimer = 60000;
