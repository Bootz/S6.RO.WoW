	...
	struct instance_halls_of_reflection_InstanceMapScript : public InstanceScript
	{
		...
		void SetData(uint32 uiType, uint32 uiData)
		{
			...
			case TYPE_FALRIC:
				...
				{
				case SPECIAL:
					HandleGameObject(m_uiExitGateGUID,false);
					break;
				}
				m_auiEncounter[uiType] = uiData;
				break;
			...
			case TYPE_MARWYN:
				...
				case DONE:
					...
					HandleGameObject(m_uiExitGateGUID,true);
					break;
				}
				m_auiEncounter[uiType] = uiData;
				break;
			...
			case TYPE_FROST_GENERAL:
				...
				{
				case DONE:
					HandleGameObject(m_uiDoor2GUID,true);
					break;
				}
				m_auiEncounter[uiType] = uiData; 
				break;
			...
			case TYPE_LICH_KING:
				...
				{
				case IN_PROGRESS:
					HandleGameObject(m_uiDoor3GUID,true);
					break;
				case DONE:
					if (m_auiLider == 1)
					{
