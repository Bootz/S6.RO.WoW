...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
	...
	// Isle of Conquest
	LANG_BG_IC_START_TWO_MINUTES        = 753,
	LANG_BG_IC_START_ONE_MINUTE         = 602,
	LANG_BG_IC_START_HALF_MINUTE        = 603,
	LANG_BG_IC_HAS_BEGUN                = 604,

	LANG_BG_IC_NODE_TAKEN               = 657,
	LANG_BG_IC_ALLY                     = 650,
	LANG_BG_IC_HORDE                    = 651,
	LANG_BG_IC_NODE_WORKSHOP            = 609,
	LANG_BG_IC_NODE_QUARRY              = 610,
	LANG_BG_IC_NODE_REFINERY            = 611,
	LANG_BG_IC_NODE_DOCKS               = 612,
	LANG_BG_IC_NODE_HANGAR              = 613,
	LANG_BG_IC_NODE_CLAIMED             = 660,
	LANG_BG_IC_NODE_ASSAULTED           = 659,
	LANG_BG_IC_NODE_DEFENDED            = 658,
